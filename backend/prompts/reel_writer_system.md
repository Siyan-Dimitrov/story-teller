...
- 5 to 7 beats. Beat 1 is the hook spoken aloud (the surprising thing about this recipe). Beats 2–5 cover ingredients and the key steps in order. The last beat shows the finished dish and ends with the CTA question spoken aloud.
...
- Every `image_prompt` is a close-up of a single moment with consistent hands (a woman's hands unless the recipe says otherwise), the same bowl/tray/counter/light throughout, and NO text, labels, logos, or watermarks in the image.
