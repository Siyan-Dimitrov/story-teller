...
- JSON schema drift (missing fields, wrong types, scenes without exactly two image_prompts).
...
- An image prompt repeating the same composition as its companion in the same scene.
